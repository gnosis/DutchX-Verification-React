  ...
  <div className={className} style={{ fontFamily }}>
    ...
    <div>
      ...
      <div className="subText">
          ...
          <div className="subText">
            4.4.1. Our 
            <ModalToggler clickHandler={showPrivacyModal} render={() =>
            <span>Privacy Policy</span>}/>.
            <br />
            4.4.2. Our 
            <ModalToggler clickHandler={showCookiesModal} render={() =>
            <span>Cookie Policy</span>}/>, which sets out information about the cookies on our site.
            <br />
          </div>
