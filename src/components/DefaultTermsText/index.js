...
const DefaultTermsText = ({ className, fontFamily = 'monospace', showCookiesModal, showPrivacyModal }) => (
    <div className={className} style={{ fontFamily }}>
        ...
        <div>
            ...
            <div className="subText">
                ...
                4.4. The Terms refer to the following additional terms, which also apply to your use of our Platform and are hereby incorporated by reference:
                  <br />
                <div className="subText">
                    4.4.1. Our <ModalToggler clickHandler={showPrivacyModal} render={() => <span>Privacy Policy</span>}/>.
                    <br />
                    4.4.2. Our <ModalToggler clickHandler={showCookiesModal} render={() => <span>Cookie Policy</span>}/>, which sets out information about the cookies on our site.
                    <br />
                </div>
            ...
            <div className="subText">
                6.1. We do not levy any fees on users of our Platform at this moment in time. This may however change in the future. A so-called liquidity contribution (instead of traditional fees) is incurred on the Protocol level and amounts to a maximum of 0.5% of the tokens deposited with the Protocol by the user and are directly taken at the time of deposit. This liquidity contribution flows to the next auction of the same auction pair as an additional sell volume. Liquidity contributions are not extracted from the Protocol.
                  <br />
                6.2. 50% of this liquidity contribution may be settled in OWL. OWL are generated by locking GNO Tokens, the native tokens of Gnosis Limited. The part of the liquidity contribution settled  in OWL are consumed and do not go to any third party.
                  <br />
                6.3. The user has the ability to lower their individual liquidity contribution  based on a mechanism defined on Protocol level. This contributions can be lowered to 0.1% of the tokens deposited with the Protocol without OWL (and to 0.05% with OWL).
                  <br />
      ...
      <br />
        ...
        <p>
            DAO CONTROL OVER THE PROTOCOL
      <br />
            The Protocol is maintained by a community-controlled decentralised autonomous organisation, the dxDAO, which may change the software code of the Protocol subject to a 30-day holding period. Those code changes may in certain circumstances negatively impact your token balance.
    </p>
    </div>
)

export default DefaultTermsText
